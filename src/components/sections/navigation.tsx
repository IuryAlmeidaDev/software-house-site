...
export function Navigation(): JSX.Element {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-neutral-200 bg-card/90 backdrop-blur">
      <div className="mx-auto flex w-[92%] max-w-7xl items-center justify-between py-5">
        ...
        <nav className="hidden items-center gap-1 md:flex">
          {links.map((link) => (
            <Button
              key={link.id}
              className="rounded-full bg-transparent px-4 py-2 text-neutral-600 shadow-none hover:bg-neutral-100 hover:text-neutral-950 hover:shadow-none"
